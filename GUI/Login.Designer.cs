namespace GUI
{
    partial class Login
    {
        ...
        private void InitializeComponent()
        {
            ...
            bt_Login.Text = "Login";
            toolTip1.SetToolTip(bt_Login, "Login button will get you into your account ");
            ...
            toolTip2.SetToolTip(bt_cancel, "Will close the program.");
            ...
            groupBox1.Controls.Add(lb_FeedbackLabel);
            ...
            toolTip3.SetToolTip(pb_ConnectionStatus, "Show your connection too the database.\r\n\r\nIf Red then no connection\r\n\r\nif green you have a connection\r\n\r\nContact admin if you can't connect: Adm@mail.com\r\n");
            // 
            // lb_FeedbackLabel
            // 
            lb_FeedbackLabel.Location = new Point(167, 14);
            lb_FeedbackLabel.Name = "lb_FeedbackLabel";
            lb_FeedbackLabel.Size = new Size(204, 18);
            lb_FeedbackLabel.TabIndex = 14;
            lb_FeedbackLabel.Text = "Checking connection to databebase";
            // 
            // img_RedGreen
            // 
        ...
        private Label lb_FeedbackLabel;
